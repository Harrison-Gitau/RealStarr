...
class AuthTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        # This is a user test json data with a predefined email and password
        self.user_data = {
    ...
    def test_already_registered_user(self):
        """Test a user cannot be registered twice."""
        res = self.client().post('/auth/register', data=self.user_data)
        self.assertEqual(res.status_code, 201)
    ...
    def test_user_login(self):
        ...
        # test that the response contains the message
    ...
    def test_non_registered_user_login(self):
        ...
        # define a dictionary to represent an un registered user
        not_a_user = {
